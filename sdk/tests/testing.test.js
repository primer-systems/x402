...
describe('Testing Utilities', () => {
  describe('fixtures', () => {
    ...
    test('exports USDC_ADDRESSES for supported networks', () => {
      expect(fixtures.USDC_ADDRESSES['base']).toMatch(/^0x[a-fA-F0-9]{40}$/);
      expect(fixtures.USDC_ADDRESSES['base-sepolia']).toMatch(/^0x[a-fA-F0-9]{40}$/);
    });
    ...
    test('exports sample402ResponseBody', () => {
      ...
      expect(fixtures.sample402ResponseBody.x402Version).toBe(1);
    ...
    test('exports samplePaymentPayload', () => {
      ...
      expect(fixtures.samplePaymentPayload.x402Version).toBe(1);
  ...
  describe('createTestPayment', () => {
    ...
    test('accepts custom network', () => {
      const header = createTestPayment({ network: 'base-sepolia' });
      const { payment } = parsePaymentHeader(header);
